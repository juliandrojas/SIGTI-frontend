...
const initialForm = { company: "Petrocasinos", asset_code: "", ip_address: "", area: "", assigned_user: "", brand: "", model: "", serial_number: "", equipment_type: "Portátil", processor: "", ram: "8 GB", operating_system: "WIN 11 Pro", hdd: "", ssd: "", nvme: false, screen_size: "14 pulgadas", antivirus: "Sophos", notes: "" };
const companyPrefixes = { Petrocasinos: { "Portátil": "PPO", Torre: "PPC", "All in One": "PPC" }, Cosecharte: { "Portátil": "CPO", Torre: "CPC", "All in One": "CPC" } };
...
export default function RegisterComponent({ embedded = false, onSaved, existingItems = [] }) {
  ...
  const handleSubmit = async (event) => {
    ...
    const requiredLabels = [["company", "empresa"], ["asset_code", "código EF"], ["ip_address", "IP"], ["area", "área"], ["assigned_user", "usuario"], ["brand", "marca"], ["model", "modelo"], ["serial_number", "serial"], ["processor", "procesador"]];
